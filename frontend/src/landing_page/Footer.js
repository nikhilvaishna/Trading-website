    ...
    <div className="container border-top mt-5" >
      <div className="row mt-5">
        <div className="col">
          ...
          <i class="fa-brands fa-x-twitter p-2 fs-4"></i>
          <i class="fa-brands fa-square-facebook p-2 fs-4"></i>
          <i class="fa-brands fa-instagram p-2 fs-4"></i>
          <i class="fa-brands fa-linkedin-in p-2 fs-4"></i> <br/>
          <i class="fa-brands fa-youtube p-2 fs-4"></i>
          <i class="fa-brands fa-whatsapp p-2 fs-4"></i>
          <i class="fa-brands fa-telegram p-2 fs-4"></i>
        </div>
        <div className="col" >
          <p>Comany</p>
          ...
          <a href="/"  style={{textDecoration:"none" , color:"grey"} }>Carrers</a> <br />
          <a href="/"  style={{textDecoration:"none" , color:"grey"} }>Zerodha.tech</a> <br />
          <a href="/"  style={{textDecoration:"none" , color:"grey"} }>Open source</a> <br />
          <a href="/"  style={{textDecoration:"none" , color:"grey"} }>Press & media</a> <br />
          <a href="/"  style={{textDecoration:"none" , color:"grey"} }>Zerodha Cares (CSR)</a> <br />
        </div>
        <div className="col">
          <p>Support</p>
          ...
          <a href="/"  style={{textDecoration:"none" , color:"grey"} }>How to file a complaint?</a> <br />
          <a href="/"  style={{textDecoration:"none" , color:"grey"} }>Status of your complaints</a> <br />
        </div>
        <div className="col">
          <p>Account</p>
